      ...
      <el-row :gutter="20">
        <el-col :span="8">
          <el-input placeholder="请输入内容" v-model="queryInfo.query">
            <el-button slot="append" icon="el-icon-search" @click="getUserList" clearable @clear="getUserList"></el-button>
            </el-input>
        </el-col>
        <el-col :span="4">
      ...
      <el-table :data="userlist" border stripe>
        ...
        <el-table-column label="状态" prop="mg_state">
          <template slot-scope="scope">
            <el-switch v-model="scope.row.mg_state" @change="userStateChange()">
            </el-switch>
          </template>
        </el-table-column>
...
export default {
    ...
    return {
      ...
      addFormRules: {
        ...
        password: [
          ...
          {min: 3,max: 10, message: '密码的长度在6-15个字符之间', tigger: 'blur'}
        ],
        email: [
  ...
  methods: {
    ...
    // 修改用户信息并提交
    editUserInfo() {
      this.$refs.editFormRef.vaildate(async vaild => {
        if (!vaild) return
